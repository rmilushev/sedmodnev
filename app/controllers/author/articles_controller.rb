module Author
  class ArticlesController < AdminController
    ...
    def author_article_params
      params.require(:article).permit(:title, :content, :published, :article_image,:remote_article_image_url, :author_id, :category_id, :golive, :importance, :tag_list, :tag, { tag_ids: [] }, :tag_ids)
    end
  end
end
